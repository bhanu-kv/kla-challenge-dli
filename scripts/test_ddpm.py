...
from metrics.psnr import calculate_psnr  # Ensure this function is defined and imported
...
if __name__ == '__main__':
    ...
    # Define paths
    test_weights_path = "../model_weights/ddpm_weights/ddpm_epoch_2.pth"  # Load final epoch weights
